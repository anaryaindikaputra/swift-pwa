...
const Layout = (props) => {
    ...
    const googleFontsDomain = 'https://fonts.googleapis.com/css2?';
    const googleFontsQuery = 'family=Poppins:ital,wght@0,400;0,500;0,600;0,700;0,900;1,400;1,500;1,600;1,700;1,900&display=swap';
    const googleFontsUrl = googleFontsDomain + googleFontsQuery;
